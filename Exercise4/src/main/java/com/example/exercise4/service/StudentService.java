...
import com.example.exercise4.repository.StudentRepository;
...
public class StudentService implements IStudentService {
    ...
    @Override
    public int countStudentsWithIeltsScore(double score) {
        return studentRepository.findByIeltsEquals(score).size();
    }
